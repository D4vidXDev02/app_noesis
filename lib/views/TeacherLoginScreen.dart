...
import '../viewmodels/teacher_login_viewmodel.dart';
...
class _TeacherLoginScreenState extends State<TeacherLoginScreen> {
  ...
  late TeacherLoginViewModel _loginViewModel;

  @override
  void initState() {
    super.initState();
    _loginViewModel = TeacherLoginViewModel();
  }
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      final result = await _loginViewModel.validateLogin();

      if (result['success'] == true) {
        // Login exitoso
        debugPrint("Login exitoso para docente");

        // Navegar al menú de docentes
        Navigator.pushReplacementNamed(context, '/teacher-menu');

        // Mostrar mensaje de bienvenida
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Bienvenido docente'),
      ...
      // Error de conexión
      debugPrint("Error en login de docente: $e");
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Consumer<TeacherLoginViewModel>(
