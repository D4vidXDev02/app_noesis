...
class ApiService {
  Future<List<Usuario>> fetchUsuarios() async {
    final response = await http.get(Uri.parse('https://noesisbackend-services.onrender.com/usuarios'));
  ...
  Future<bool> registrarUsuario(String email, String password) async {
    final response = await http.post(
      Uri.parse('https://noesisbackend-services.onrender.com/usuarios/registro'),
      headers: {
  ...
  static Future<Map<String, dynamic>> getBestScore(String email) async {
    try {
      final response = await http.get(
        Uri.parse('https://noesisbackend-services.onrender.com/usuarios/$email/puntajes'),
